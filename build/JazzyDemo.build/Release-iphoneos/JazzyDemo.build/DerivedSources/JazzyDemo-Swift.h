...
/// 🚲 自行车，一个人力驱动的交通工具
SWIFT_CLASS("_TtC9JazzyDemo7Bicycle")
...
/// 自行车行使的旅程数
@property (nonatomic, readonly) NSInteger numberOfTrips;
...
/// 骑自行车出去溜一溜
///
/// \param meters 行使的距离单位为米
- (void)travelWithDistance:(double)meters;
@end


@interface Bicycle (SWIFT_EXTENSION(JazzyDemo))
